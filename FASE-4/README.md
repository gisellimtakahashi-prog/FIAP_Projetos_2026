...
### 👤 Integrantes:
* David Ribeiro Prado de Lacerda - RM 570350
...
* **Ambiente de Desenvolvimento (IDE)**: PyCharm (versão 2024 ou superior) ou VS Code.
* **Linguagem**: Python (versão 3.10 ou superior instalada e adicionada ao PATH).
* **Bibliotecas Python (Dependências)**:
  * `pandas` (Manipulação de dados estruturados)
  * `numpy` (Operações matemáticas e arrays)
  * `matplotlib` e `seaborn` (Geração de gráficos e visualizações)
---
