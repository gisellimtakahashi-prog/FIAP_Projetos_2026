...
readme_content = """# Lunar Resource & Solar Weather Integrated Monitor (v1.0)
...
Estudos geoquímicos (e.g., Cameron, 1992) confirmam que a eficiência de aprisionamento do $^3\text{He}$ está correlacionada com a abundância de Dióxido de Titânio ($\text{TiO}_2$) presente na **Ilmenita** ($\text{FeTiO}_3$). A malha cristalina deste mineral atua como uma armadilha molecular estável para os íons incidentes. 
